...
export class FollowupService {
  ...
  getCallList(userId:string, sessionKey:string) {
    ...
    "AND eventstatus != 'Not Held' AND date_start > '"+ dateToday +"' AND assigned_user_id = '19x" + userId +"' LIMIT 20;";
    // "AND eventstatus != 'Not Held' AND date_start >= '"+ dateToday +"' LIMIT 20;"; //AND assigned_user_id = '19x" + userId +"' LIMIT 20;";
    const sessionName = sessionKey;
