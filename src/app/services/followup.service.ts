...
export class FollowupService {
  ...
  getFollowupList(userId:string ,sessionkey:string){
    ...
    "AND eventstatus != 'Not Held' AND start_date < '"+ dateToday +"' AND start_date > '" + startDueDate + "' AND assigned_user_id = '19x" + userId +"' LIMIT 20;";
    // "AND eventstatus != 'Not Held' AND start_date < '"+ dateToday +"' AND start_date > '" + startDueDate + "' LIMIT 20;"; //AND assigned_user_id = '19x" + userId +"' LIMIT 20;";
